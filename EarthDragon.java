...
/**
 * Creates and adds the required information in order to create a new EarthDragon. 
 * 
 * @author Brandon Bruno
 */
public class EarthDragon extends Dragon implements Tamable
{    
    private Scanner input;
    
    /**
     * Default constructor for class EarthDragon.
     */
    public EarthDragon()
    {
     ...
     */
    public EarthDragon(String owner)
    {
     ...
     */
    public EarthDragon(String type, String owner, String nature, String name, String gender, int level, double exp)
    {
        setType(type);
        setOwner(owner);
        setNature(nature);
    ...
    public void decideNature()
    {
        ...
        {
            nature = "Takes plenty of naps";
        }//ends the else if
        else if(i > 50 && i <= 75)
        {
            nature = "Is oddly energetic";
        }//ends the else if
        else
        {
            nature = "Is patient and wise";
        }
    ...
    {
        System.out.println("What do want your newly tamed EARTH dragon to be named?");
     ...
     * Earth dragons have a 50% chance to be female and a 50% chance to be male. 
     */
